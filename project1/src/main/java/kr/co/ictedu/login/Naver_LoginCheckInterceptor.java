...
public class Naver_LoginCheckInterceptor extends HandlerInterceptorAdapter {

	private final static Logger logger = LoggerFactory.getLogger( Naver_LoginCheckInterceptor.class );
