			...
			<div class="container">
				<div class="v48_73">
					...
					<%
					    ...
					    String redirectURI = URLEncoder.encode("http://localhost:8081/ictedu/login/naver_callback", "UTF-8");//CallBack URL";
					...
					<div class="v342_47">
	                    ...
	                    <a href="https://kauth.kakao.com/oauth/authorize?client_id=cf8c2b8f99409406ce4505e3f2eb3c58&redirect_uri=http://localhost:8081/ictedu/login/kakao_login&response_type=code">
