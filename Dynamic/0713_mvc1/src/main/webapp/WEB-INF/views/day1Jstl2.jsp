...
<html>
	...
	<body>
		...
		<c:choose>
			<c:when test="${ jumsu > 90 }"><h2><font color="blue"> A GRADE </font></h2></c:when>
			<c:when test="${ jumsu > 80 }"><h2><font color="blue"> B GRADE </font></h2></c:when>
			<c:when test="${ jumsu > 70 }"><h2><font color="blue"> C GRADE </font></h2></c:when>
			<c:when test="${ jumsu > 60 }"><h2><font color="blue"> D GRADE </font></h2></c:when>
			<c:otherwise><h2><font color="blue"> F Grade </font></h2></c:otherwise>
		</c:choose>
	</body>
</html>