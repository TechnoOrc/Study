...
-- 테이블 ict.memo_chat 구조 내보내기
DROP TABLE IF EXISTS `memo_chat`;
CREATE TABLE IF NOT EXISTS `memo_chat` (
...
-- 테이블 ict.memo_room 구조 내보내기
DROP TABLE IF EXISTS `memo_room`;
CREATE TABLE IF NOT EXISTS `memo_room` (
...
-- 테이블 ict.product_favorite 구조 내보내기
