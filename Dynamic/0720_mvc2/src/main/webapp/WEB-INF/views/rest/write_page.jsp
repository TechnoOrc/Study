...
<html>
	<head>
		<meta charset="UTF-8">
		<title> /restmbrbrdview/write_page </title>
	...
	<%@ include file="/WEB-INF/views/header.jsp" %>
		<hr>
		<h3> /restmbrbrdview/write_page </h3>
		<hr>
		...
		<a href="${pageContext.request.contextPath}/restmbrbrdview/list_page">
	...
	$(document).ready(function() {
		$("#write_btn").click(function() {
			...
			$.post(
					"${pageContext.request.contextPath}/restmbrbrd/"
					, {
						title : $("#title").val()
